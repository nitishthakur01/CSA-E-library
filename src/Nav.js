...
<div className='Shortnav'>
        <div>
                <img className='logo1' src={Logo} alt="no image"/>
        </div>
        <ol className="snav">
        <li><Link className='snavlink' to ="">MCA</Link></li>
        <li><Link className='snavlink' to ="">BCA</Link></li>
        <li><Link className='snavlink' to ="">M phil</Link></li>
        <li> <Link className='snavlink' to ="">Phd</Link></li>
        </ol>
</div>
<Switch>
